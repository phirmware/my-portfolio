...
export const resumeData = {
  ...
  projects: [
    {
      id: 'event-driven-framework',
      title: 'Event-Driven Architecture Framework',
      shortDesc: 'Reusable TypeScript library for building event-driven microservices on AWS',
      description:
        'Designed a reusable TypeScript library for building event-driven microservices on AWS with built-in retry logic, dead-letter queues, and observability hooks. Adopted across 3 teams for rapid service development.',
      tech: ['TypeScript', 'AWS SNS/SQS', 'Node.js', 'DLQ', 'Observability'],
      impact: 'Adopted by 3 teams, accelerating new service development significantly',
      questions: [
        'What problem does this framework solve?',
        "Tell me a fun fact about building this",
        'Recruiter-friendly summary of this project',
      ],
    ...
    },
    {
      ...
      shortDesc: 'Terraform modules for common AWS patterns with security best practices',
      description:
        'Created comprehensive Terraform modules for common AWS patterns (API Gateway + Lambda, ECS + ALB, VPC networking) with security best practices baked in, reducing new service setup from 2 days to 2 hours.',
      tech: ['Terraform', 'AWS', 'Serverless Framework', 'IaC', 'Security'],
      impact: 'Reduced new service setup from 2 days to 2 hours',
      questions: [
        'What AWS patterns are covered?',
        'How did this save the team time?',
        'What security practices are built in?',
      ],
      color: 'from-violet-500/20 to-indigo-500/20',
      accentColor: '#a78bfa',
    },
    {
      id: 'magma-contributor',
      title: 'Facebook Magma — Core Contributor',
      shortDesc: 'Open-source LTE/5G network orchestration platform (10K+ stars)',
      description:
        'Contributed to the open-source Magma LTE/5G network orchestration platform with 10K+ stars. Implemented telemetry collection, CI/CD improvements, and operator tooling. Earned committer status through 15+ merged pull requests.',
      tech: ['Golang', 'Kubernetes', 'gRPC', 'Prometheus', 'Open Source'],
      impact: '15+ PRs merged, earned committer status, extended 4G coverage across West Africa',
      questions: [
        'What did contributing to open source teach you?',
        "What's the most interesting thing about Magma?",
        'How did this impact real users?',
      ],
